...
dy0 = 1.09774e-05; % Near-wall grid size (m)
...
if iwave == 1 % Input for second-order Stokes signal, with free stream velocity: U_1m*sin(omega*t) - U_2m*cos(2*omega*t)
  U_1m = 2; % Primary amplitude of free stream velocity, U0m (m/s)
...
% Sediment input
d = 5e-6; % Grain size (m)
k_s = 0.00084; % Nikuradse's equivalent sand grain roughness (m)
